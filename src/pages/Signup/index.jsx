...
export default function Signup() {
  ...
  const handleSubmit = async event => {
    ...
    try {
      const response = await axios.post('https://muj-backend.onrender.com/user/register', 
        rgtsrnBody
      );

      console.log(response.status,'dat')
      ...
      console.log('status for admin : ' + response.status);
    } catch (error) {
      setmsg('Registration Failed');
